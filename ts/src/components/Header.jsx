        ...
        <header className="site__header d-lg-block d-none">
          <div className="site-header">
            ...
            <div className="site-header__middle container">
              <div className="site-header__logo"><a href="index.html"><svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div className="nav-panel__nav-links nav-links">
                      <ul className="nav-links__list">
                        <li className="nav-links__item nav-links__item--with-submenu"><a
                          href="index.html"><span>Trang chủ <svg className="nav-links__arrow" width="9px"
                            height="6px">
                    ...
                    <div className="nav-panel__indicators">
                      ...
                      <div className="indicator indicator--trigger--click"><a href="cart.html"
                        className="indicator__button"><span className="indicator__area">
                          ...
                          {/* <use clasxlinkHref="./assets/Ic_shopping_cart_48px.svg"></use> */}
